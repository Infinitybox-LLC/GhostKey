# 1 "/var/folders/bj/9hlf5cr55td9xzwfkbc27rdr0000gy/T/tmpum1omc1b"
#include <Arduino.h>
...
#define BLE_DEEP_SLEEP_INTERVAL_MS 60000
#define BLE_DEEP_SLEEP_DURATION_MS 10000
...
unsigned long adaptiveDeepSleepInterval = 60000;
unsigned long currentWindowInterval = 60000;
unsigned long lightSleepTimeout = 30000;
int consecutiveWeakConnections = 0;
bool isQuickSampling = false;
unsigned long quickSamplingStart = 0;
float lastQuickConfidence = 0.0f;
bool quickConfidenceCompleted = false;
#define QUICK_SAMPLING_DURATION 5000
...
# 517 "/Users/zkhan/GhostKey/src/GhostKey.ino"
...
# 588 "/Users/zkhan/GhostKey/src/GhostKey.ino"
...
#line 588 "/Users/zkhan/GhostKey/src/GhostKey.ino"
void cleanupNVSStorage() {
...
void setup() {
    ...
    if (preferences.getBool("bt_enable_on_restart", false)) {
        ...
        preferences.putBool("bt_enable_on_restart", false);
...
# 4074 "/Users/zkhan/GhostKey/src/GhostKey.ino"
int8_t medianFilter(int8_t newValue) {
...
float calculateQuickConfidence() {
    ...
    float trendScore = TREND_WEIGHT * 0.5f;
...
void updateAdaptiveInterval(bool success) {
    if (success) {
        ...
        if (consecutiveWeakConnections >= 5) {
            ...
            resetAdaptiveInterval();
            consecutiveWeakConnections = 1;
            adaptiveDeepSleepInterval = 120000;
...
void resetAdaptiveInterval() {
    adaptiveDeepSleepInterval = 60000;
    consecutiveWeakConnections = 0;
