            ...
            <main class="content">
                    ...
                    <div class="card">
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            <p style="font-size: 0.9rem; color: #666; margin-bottom: 1.5rem;">
                                Calibrate the system for your specific installation. Position your phone where you want authentication to work, then run calibration. Device will beep when calibration is finished.
                            </p>
                ...
                <section class="content-section" id="securitySection">
                    ...
                    <div style="text-align: center; margin-top: 2rem; padding: 1rem;">
                        <p style="font-size: 0.75rem; color: #999; margin: 0;">Ghost Key v0.10.5</p>
                    </div>
                </section>
